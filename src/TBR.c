	  ...
	  if (verbose)
	    {
	      ...
	      printf("  . Old tree length is %lf, new tree length should be %lf.\n",T->weight, T->weight + 0.25*bestWeight);
	    }
//	  fprintf (statfile, "\tTBR: Tree length is %lf, new tree length should be %lf.\n",T->weight, T->weight + 0.25*bestWeight);
	  ...
	  (*count)++;
	  if (verbose)  
	    printf("  . TBR %5d: new tree length is %lf.\n", *count, T->weight);
	  fprintf (statfile, "\tTBR  %5d: new tree length is %lf.\n", *count, T->weight);
	}
      else	
	bestWeight = 1.0;
